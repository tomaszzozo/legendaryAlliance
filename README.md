...
Tytuł roboczy gry to "Legendary Alliance". Gra jest przeznaczona dla od dwóch do czterech graczy włącznie. Gracze muszą podłączyć się na różnych maszynach, ale nie jest konieczne zachowanie między nimi tego samego systemu operacyjnego.
