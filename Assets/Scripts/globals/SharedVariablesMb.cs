...
public class SharedVariablesMb : MonoBehaviour
{
    ...
    public static void SetRoomToJoin(string roomToJoinId)
    {
        PlayerPrefs.SetString("roomToJoinId", roomToJoinId);
    }

    public static string GetRoomToJoin()
    {
        return PlayerPrefs.GetString("roomToJoinId");
    }
}
...
public static class SharedVariables
{
    ...
    {
        return PlayerPrefs.GetInt("isAdmin") == 1;
    }
}